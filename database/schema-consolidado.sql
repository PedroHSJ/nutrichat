-- Sistema de Autenticação NutriChat com Supabase Auth - SCHEMA CONSOLIDADO
-- Este schema substitui o sistema de sessões anônimas por autenticação tradicional
-- Versão corrigida sem a coluna timestamp conflitante
...
-- Tabela de mensagens (criptografadas) - SEM COLUNA timestamp CONFLITANTE
...
CREATE OR REPLACE TRIGGER update_message_count
...
SELECT 'Schema NutriChat instalado com sucesso!' as status,
       'Tabelas: user_profiles, chats, messages' as tables_created,
       'RLS habilitado e políticas configuradas' as security,
       'Triggers e funções LGPD ativas' as features;