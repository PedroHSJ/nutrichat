      ...
      <SheetContent side="left" className="w-[400px]">
        ...
        <div className="mt-6 space-y-4">
          ...
          <div className="text-xs text-muted-foreground space-y-2">
            <p>
              <strong>Para alternar entre APIs:</strong>
            </p>
            <p>
              1. Configure as variáveis no arquivo <code>.env.local</code>
            </p>
            <p>
              2. Defina <code>AI_PROVIDER</code> como:
            </p>
            <ul className="ml-4 space-y-1">
              <li>
                • <code>openai</code> para ChatGPT
              </li>
              <li>
                • <code>github</code> para GitHub Models
              </li>
            </ul>
